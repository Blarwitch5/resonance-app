...
const KNOWN_ERRORS: Record<string, string> = {
  ...
  "An artist and a title stay between 1 and 200 characters.": "error.pressingName",
  "That year could not be kept.": "error.pressingYear",
  "That label could not be kept.": "error.pressingLabel",
  "That barcode could not be kept.": "error.pressingBarcode",
  "Choose a JPEG, PNG, or WebP sleeve.": "error.coverKind",
  "This cover is too large to keep.": "error.coverSize",
  "This cover could not be kept just now.": "error.coverKeep",
